    ...
    if (!user)
      return (
        <div className="page empty">
          ...
          <p>Sign in with an internal growth account to view this report.</p>
          <Link className="button primary" href="/profile?next=/experiments">
            Sign in
          </Link>
        </div>
      );
    ...
    if (!allowed)
      return (
        <div className="page empty">
          ...
          <p>
            This report is available to the internal growth team. Your own
            circle’s metrics are in Creator studio.
          </p>
