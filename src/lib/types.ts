...
export interface AnalyticsEvent { id: string; user_id: string | null; anonymous_session_id: string; group_id: string | null; event_name: EventName; experiment_id: string | null; experiment_variant: Variant | null; metadata: Record<string, unknown>; created_at: string; is_demo: boolean; }
